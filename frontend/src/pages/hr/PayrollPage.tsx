    ...
    return (
        <div>
            <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: 16 }}>
                ...
                <Button type="primary" onClick={() => setIsModalOpen(true)}>Generate Payroll</Button>
            </div>
            ...
            >
                <Form form={form} layout="vertical" onFinish={(v) => generateMutation.mutate(v)} initialValues={{ period: currentPeriod }}>
